...
/** Tick chọn ở trang "Rà soát SLA" rồi đánh dấu ghi nhận — chỉ để theo dõi/báo
 * cáo trách nhiệm, KHÔNG đổi trạng thái, Workspace hay hành vi nào khác của
 * liên hệ. Bỏ qua các dòng đã được đánh dấu trước đó (idempotent). */
