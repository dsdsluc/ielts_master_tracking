...
// Toàn bộ nội dung "Học viên đang tư vấn" — tách riêng khỏi students/page.tsx
// để dùng chung được ở /workspace (đã gộp chức năng này vào Workspace của Sale).
export async function StudentsSection({ actor }: { actor: CurrentUser }) {
